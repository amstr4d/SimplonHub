...
btnadd.on('click', function (event) {
    ...
    //je récupère la valeur texte tapé dans le textarea
    let textajout = $("#ajouttext").val();
    console.log(textajout);
    //je crée une condition pour que js vide le tableau précédent et remplace par les éléments nouveau ajoutés (pour qu'il ne répète pas le tableau on le vide le <p> avant avec .empty)
    if (textajout !== '') {
    ...
    function bloup() {
        //je crée une boucle qui va permettre d'injecter de les ajouts dans le html
